...
def test_first_fit_uses_first_machine_that_can_fit() -> None:
    machines = [
        Machine(id=1, name="small", total_cpu=1, total_memory=8192),
        Machine(id=2, name="medium", total_cpu=4, total_memory=8192),
        Machine(id=3, name="large", total_cpu=8, total_memory=16384),
    ]
...
def test_best_fit_uses_tightest_combined_resource_fit() -> None:
    machines = [
        Machine(id=1, name="large", total_cpu=8, total_memory=16384),
        Machine(id=2, name="medium", total_cpu=4, total_memory=8192),
    ]
...
def test_worst_fit_uses_largest_remaining_combined_resource_fit() -> None:
    machines = [
        Machine(id=1, name="medium", total_cpu=4, total_memory=8192),
        Machine(id=2, name="large", total_cpu=8, total_memory=16384),
    ]
...
def test_round_robin_advances_after_successful_allocation() -> None:
    machines = [
        Machine(id=1, name="a", total_cpu=4, total_memory=8192),
        Machine(id=2, name="b", total_cpu=4, total_memory=8192),
    ]
...
def test_least_loaded_prefers_machine_with_lower_cpu_and_memory_utilization() -> None:
    machines = [
        Machine(id=1, name="busy", total_cpu=4, total_memory=8192, used_cpu=3, used_memory=6144),
        Machine(id=2, name="light", total_cpu=4, total_memory=8192, used_cpu=1, used_memory=2048),
    ]
